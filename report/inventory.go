...
// 	TotalWeight      float32           `bson:"total_weight,omitempty" json:"total_weight,omitempty"`
...
// 	WasteWeight      float32           `bson:"waste_weight,omitempty" json:"waste_weight,omitempty"`
// 	DonateWeight     float32           `bson:"donate_weight,omitempty" json:"donate_weight,omitempty"`
...
// 	SalePrice        float32           `bson:"sale_price,omitempty" json:"sale_price,omitempty"`
// 	SoldWeight       float32           `bson:"sold_weight,omitempty" json:"sold_weight,omitempty"`
...
// 		if !ok {
// 			if upcType == reflect.Float32 {
// 				i.UPC = int64(m["upc"].(float32))
// 			} else {
...
// 		if !ok {
// 			if skuType == reflect.Float32 {
// 				i.SKU = int64(m["sku"].(float32))
// 			} else {
...
// 		i.TotalWeight, ok = m["total_weight"].(float32)
// 		if !ok {
// 			if totalWeightType != reflect.Float32 {
// 				val, _ := strconv.Atoi((m["total_weight"]).(string))
// 				i.TotalWeight = float32(val)
// 			}
// 		}
// 	}
...
// 		i.Price, ok = m["price"].(float32)
// 		if !ok {
// 			if priceType != reflect.Float32 {
...
// 		if !ok {
// 			if datearrivedType == reflect.Float32 {
// 				i.DateArrived = int64(m["date_arrived"].(float32))
// 			} else {
...
// 		if !ok {
// 			if expiryDateType == reflect.Float32 {
// 				i.ExpiryDate = int64(m["expiry_date"].(float32))
// 			} else {
...
// 		if !ok {
// 			if timestampType == reflect.Float32 {
// 				i.Timestamp = int64(m["timestamp"].(float32))
// 			} else {
...
// 		if !ok {
// 			if datesoldType == reflect.Float32 {
// 				i.DateSold = int64(m["date_sold"].(float32))
// 			} else {
...
// 		i.WasteWeight, ok = m["waste_weight"].(float32)
// 		if !ok {
// 			if wasteWeightType != reflect.Float32 {
// 				val, _ := strconv.Atoi((m["waste_weight"]).(string))
// 				i.WasteWeight = float32(val)
// 			}
// 		}
// 	}
...
// 		i.DonateWeight, ok = m["donate_weight"].(float32)
// 		if !ok {
// 			if donateWeightType != reflect.Float32 {
// 				val, _ := strconv.Atoi((m["donate_weight"]).(string))
// 				i.DonateWeight = float32(val)
// 			}
// 		}
// 	}
...
// 		i.SalePrice, ok = m["sale_price"].(float32)
// 		if !ok {
// 			if salePriceType != reflect.Float32 {
// 				val, _ := strconv.Atoi((m["sale_price"]).(string))
// 				i.SalePrice = float32(val)
// 			}
// 		}
// 	}
...
// 		i.SoldWeight = m["sold_weight"].(float32)
// 		if !ok {
// 			if soldWeightType != reflect.Float32 {
// 				val, _ := strconv.Atoi((m["sold_weight"]).(string))
// 				i.SoldWeight = float32(val)
// 			}
// 		}
// 	}
...
// 		if !ok {
// 			if versionType == reflect.Float32 {
// 				i.Version = int64(m["version"].(float32))
// 			} else {
